...
gulp.task('vendor', function() {
	...
	return gulp.src(['source/js/delete-style-noJs.js', 'source/js/toggle-popup.js', 'source/js/checkbox-checked.js', 'source/js/slider.js', 'source/js/selection.js', 'source/js/video-size.js', 'source/js/contact-forms.js', 'source/js/scroll-anchor.js', 'source/js/main.js'])
